...
def get_filters():
    ...
    city = input('Please, type in the name of the city you will like to explore from the options provided; chicago, new york city or washington: \n').lower()
    while (city not in (CITY_DATA).keys()):
        print('\nPlease, enter an appropriate selection from the options available!')
        city = input('Please, type in the name of the city you will like to explore from the options provided; chicago, newyork or washington: \n').lower()
        break
